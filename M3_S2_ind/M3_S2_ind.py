...
# Cree un método llamado "describir_usuario()"" que imprima un resumen de la información del usuario.
    ...
    def describir_usuario(self):
        return "{} {}, de edad {} años y género {} que vive en {}.".format(self.nombre_usuario, self.apellido_usuario, 
                                                                        self.edad_usuario, self.genero_usuario, 
                                                                        self.direccion_usuario)

# Cree otro método llamado saludar_usuario() que imprima un saludo personalizado para el usuario.

    def saludar_usuario(self):
        if self.genero_usuario == "masculino":
            return "Hola {} {}, bienvenido al mundo!".format(self.nombre_usuario, self.apellido_usuario)
        else:
            return "Hola {} {}, bienvenida al mundo!".format(self.nombre_usuario, self.apellido_usuario)
...
usuario_1 = Usuario("José", "Lopez","32", "masculino", "Bilbao #123")
...
usuario_3 = Usuario("Patricia", "Perez", "54", "femenino", "Gran. Avenida #789")
...
usuario_4 = Usuario("Martín", "vasquez","21", "masculino", "Juan Ramón #321")
print(usuario_4.saludar_usuario()) # llamando al método saludar_usuario
print(usuario_4.describir_usuario()) # llamando al método describir_usaurio
print()
